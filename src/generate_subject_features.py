...
def extract_features_from_subject(feature_extractor, configuration,subject,):
...
for subject in range(1, 13):
    ...
    (feature_extractor, extractor_file) = train_feature_extractor(train_raw,
                                                                  ...
                                                                  feature_extractor)
Parallel(n_jobs=configuration.get_maximum_parallel_jobs())(
    delayed(extract_features_from_subject)(feature_extractor,configuration,subject) for subject in range(1,13))
